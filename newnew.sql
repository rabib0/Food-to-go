...
(1, 58, 'Juicy Masala Paneer Kathi Roll', 40, 2, '2019-03-03', 'ckumar', 1),
...
INSERT INTO `new` (`order`, `F`, `food`, `pr`, `quant`, `datee`, `name`, `ID`) VALUES
(1, 58, 'Juicy Masala Paneer Kathi Roll', 40, "sunday", '2019-03-03', 'ckumar', 1);
